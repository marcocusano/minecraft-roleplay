...
class CreateRequest extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            'slug' => 'required|unique:companies,slug|string|min:3|max:50',
    ...
    public function messages() {
        return [
            ...
            // Uniques
            "slug.unique" => "Non possono esistere più Aziende con lo stesso slug.",
            ...
            "is_government.boolean" => "Specifica un valore vero o falso, che indichi se è un'Azienda Pubblica o meno.",
