**WARNING!!! THE CURRENT GUIDE IS ACTUALLY JUST A DOCUMENTATION AND I SHARED TECHNICAL INFORMATIONS ONLY. THE MINECRAFT PLUGIN (Roleplay Engine) AND THE VUE.JS WEB APPLICATION (Roleplay Management System) ARE STILL UNDER DEVELOPMENT AS LONG AS THE PHP VERSION WAS. YOU MAY CLONE THIS REPO WHEN THIS MESSAGE WILL BE REMOVED AND WHEN YOU SEE A VERSION ON TOP OF THIS README FILE!**
